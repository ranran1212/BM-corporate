...
commands.about = (term) => {
  term.typeLines([
    { html: '' },
    { html: '<span class="ascii-logo">BBBB  L     U   U  EEEE</span>' },
    { html: '<span class="ascii-logo">B   B L     U   U  E   </span>' },
    { html: '<span class="ascii-logo">BBBB  L     U   U  EEE </span>' },
    { html: '<span class="ascii-logo">B   B L     U   U  E   </span>' },
    { html: '<span class="ascii-logo">BBBB  LLLLL  UUU   EEEE</span>' },
    { html: '<span class="ascii-logo">M   M EEEE N   N H   H EEEE RRRR  AAAAA</span>' },
    { html: '<span class="ascii-logo">MM MM E    NN  N H   H E    R   R A   A</span>' },
    { html: '<span class="ascii-logo">M M M EEE  N N N HHHHH EEE  RRRR  AAAAA</span>' },
    { html: '<span class="ascii-logo">M   M E    N  NN H   H E    R  R  A   A</span>' },
    { html: '<span class="ascii-logo">M   M EEEE N   N H   H EEEE R   R A   A</span>' },
    { html: '<span class="ascii-logo">(\\ (\\ (\\ /) /) /)   (\\ (\\ (\\ /) /) /)</span>' },
    { html: '<span class="ascii-logo">(\'ㅅ\'( \'ㅅ\' )\'ㅅ\')   (\'ㅅ\'( \'ㅅ\' )\'ㅅ\')</span>' },
    { html: '<span class="ascii-logo">(\\ (\\ (\\ /) /) /)   (\\ (\\ (\\ /) /) /)</span>' },
    { html: '<span class="ascii-logo">(\'ㅅ\'( \'ㅅ\' )\'ㅅ\')   (\'ㅅ\'( \'ㅅ\' )\'ㅅ\')</span>' },
    { html: '<span class="ascii-logo"> (\\ (\\ (\\ /) /) /)  (\\ (\\ (\\ /) /) /)</span>' },
    { html: '<span class="ascii-logo"> (\'ㅅ\'( \'ㅅ\' )\'ㅅ\')  (\'ㅅ\'( \'ㅅ\' )\'ㅅ\')</span>' },
